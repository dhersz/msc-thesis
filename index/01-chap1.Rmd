...
Let's cite @book-example, @article-example, @techreport-exampleIn, @techreport-example, @inproceedings-example, @incollection-example, @inbook-example, @mastersthesis-example, @phdthesis-example.
